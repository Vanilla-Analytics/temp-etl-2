...
@activity.defn
async def shopify(request: AccountPayload):
    try:
        ...
        from .src.extraction import ShopifyClient
        ...
        client = ShopifyClient(shop_name=shop_name,access_token=access_token,fill_type=fill_type,start_time=start_time)
